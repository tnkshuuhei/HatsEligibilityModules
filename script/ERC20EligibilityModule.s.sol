...
contract Deploy is Script {
  ERC20Eligibility implementation;
  ...
  function run() public {
    ...
    implementation = new ERC20Eligibility{ salt: SALT }(version);
    vm.stopBroadcast();
  ...
  // forge script script/ERC20EligibilityModule.s.sol:Deploy -f goerli --broadcast --verify
}
